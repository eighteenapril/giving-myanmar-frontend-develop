                                ...
                                <div className="footer-widget-two__contact">
                                    ...
                                    <ul className="footer-widget-two__contact-list list-unstyled">
                                        <li>
                                            ...
                                            <p><Link href="tel:+959450067060">(+95)-9-450067060</Link></p>
                                        </li>
                                        <li>
                                            <div className="icon">
                                                <span className="icon-envelope"></span>
                                            </div>
                                            <p><Link href="mailto:admin@gm.com">admin@gm.com</Link></p>
                                        </li>
                                    </ul>
                            ...
                            <div className="col-xl-12">
                                <div className="site-footer-two__bottom-inner">
                                    <div className="site-footer-two__copyright">
                                        <p className="site-footer-two__copyright-text">Copywright 2024 by <Link href="#">Giving Myanmar</Link>. All
                                            Rights Reserved.</p>
                                    </div>
